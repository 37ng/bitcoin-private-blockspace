...
`raw/out/` and `raw/.cache/`, this directory is in git: a reader
should be able to reproduce a figure from it without BigQuery credentials.

| file | written by | holds |
|---|---|---|
| `accelerations_monthly.json` | `acceleration/export_accelerations.py` | out-of-band spend per calendar month |
...
See `acceleration/export_accelerations.py` for why that is the whole test.
