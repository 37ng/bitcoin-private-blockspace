...
SELECT
  ...
  COALESCE(f.lower_band_sats_50, 0) AS lower_band_sats_50,
  COALESCE(f.upper_band_sats_50, 0) AS upper_band_sats_50,
  COALESCE(f.lower_band_sats_30, 0) AS lower_band_sats_30,
  COALESCE(f.upper_band_sats_30, 0) AS upper_band_sats_30,
  COALESCE(f.lower_band_sats_70, 0) AS lower_band_sats_70,
  COALESCE(f.upper_band_sats_70, 0) AS upper_band_sats_70,
  n.nonrelayable_txs,
