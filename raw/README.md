...
A second, separate pipeline in [`acceleration/`](../acceleration/) crawls
the mempool.space acceleration history and writes into its own dataset. See
`acceleration/README.md` for how it works and how it relates to this one.
